...
Kindle著書に「髪が変わると、人生が若返る」「美容室×AI」「AI作曲SUNO完全ガイド」「薄毛は生活習慣で変えられる！」「仕事で使えるフェルミ推定」がある。
...
━━━━━━━━━━━━━━━━━━━━
■ 業態：40代からのたるみ・むくみを整える小顔リフトアップ専門サロン（プライベートエステサロン）
■ 住所：千葉県市川市市川1-22-11 ドエル市川弐番館204
■ TEL：080-4861-3110
■ 営業時間：月・木・金 9:00〜20:00 / 土日祝 9:00〜17:00 / 火・水 13:00〜18:00
■ 定休日：不定休
■ 当日予約OK / 日祝も営業
■ 予約：LINE予約がおすすめ（http://lin.ee/qcUB3mN）「初めてです」と送るだけでOK。電話（080-4861-3110）やお問い合わせフォーム（https://www.ferite.jp/）からも可能
■ 公式LINE：http://lin.ee/qcUB3mN
■ Web：https://www.ferite.jp/
■ 24時間受付中・無理な勧誘一切なし
■ オーナー：齋藤裕子（エステ歴36年・CIDESCO国際エステティシャン・日本エステティック協会認定指導講師）
24,000人以上の施術実績。サロンでの施術のほか、美と健康のダイエット指導をご希望のお客様に行っています。また、全国の個人事業のエステサロン様向けに、Webを活用した運営サポート・指導も行っています。

■ コンセプト：
"頑張らなくても変わる" 整えるケアで、自然な若々しさへ。
「健康的な美しさで上向きな人生を」「お客様の365日のキレイ」を全力で応援。
年齢ではなく「むくみ・ゆがみ・巡り」に着目し、骨格・筋肉・リンパの流れを整え、自然で若々しい印象へ導きます。
...
・白い天蓋のあるプライベートな施術室で非日常のひとときを提供

■ こんなお悩みに対応：
・顔が大きくなった気がする
・疲れて見えると言われるようになった
・ほうれい線、おでこのしわ、目の下のたるみ
・むくみ・ゆがみによる顔の大きさ
・フェイスラインのたるみ
・肌の乾燥・くすみ

■ 施術の3つのアプローチ：骨格（STRUCTURE）・筋肉（MUSCLE）・巡り（CIRCULATION）

■ メニュー（税込）：
・ベーシックコース ¥11,000（施術30分/所要45分）
 エンドリングフェイシャル小顔矯正（むくみ取り・筋肉の若返り・骨格矯正・美容気功）※メイクしたまま施術可能
・ゴールドコース ¥14,300（施術45分/所要60分）★人気No.1
...
16. 公式LINEについて聞かれた場合は、各サロンの公式LINEをご案内してください。Moulin-R（ムーランアール）の公式LINE：https://lin.ee/tyFeLFR、salon de Feirte（サロンドフェリテ）の公式LINE：http://lin.ee/qcUB3mN です。「お友だち追加していただくと、最新情報やお得な情報をお届けします✨」のように案内してください。お客様がどちらのサロンについて聞いているかに応じて、該当するLINEをご案内してください。特に指定がない場合は両方をご案内してください。
`;
