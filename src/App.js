...
同一店舗内にマツエク・まつ毛パーマ専門の「LIALI（リアリ）」がシェアサロンとして併設されています。■ シャンプー＆トリートメント：
お一人ひとりの地肌・髪質・ヘアデザインに応じ、20種類の組み合わせで施術しています。ご希望に応じ販売もしています。・かつらやヘアピースのカットやカラーリングもご希望に応じ承ります。
※エステをご希望の方は、グループのエステ専門サロン「salon de Feirte（サロンドフェリテ）」をご案内いたします。

■ ヘアメニュー（税込）：
・カット ¥5,500（施術時間約80分）シャンプー＋2種の本格マッサージつき
・前髪カット ¥2,200
・眉メイク（眉カット）¥2,200（ヘアと同時で半額）。眉カラーも承ります。
・クイックカット ¥4,400
...
■ Web：http://ferite.jp/
■ オーナー：齋藤裕子（さいとうゆうこ）（エステ歴30年・CIDESCO国際エステティシャン・日本エステティック協会認定指導講師）
齋藤裕子は美と健康のコンシェルジュとしても活動しており、全国の美容専門家に向けた講習会をZoomを通じて開催しています。また、一般の方に向けて健康的な痩身の提案も行っています。
【齋藤裕子の主な著書（すべてKindle出版）】
・スル痩せダイエット（シリーズ）
 └ 50代から始める！無理なく健康的に痩せるための楽しいガイド
 └ 栄養講座①
 └ 栄養講座②
・知らないと損するダイエットのヒント60
■ コンセプト：
